...
const relatedLinks = [
  {
    ...
    href: "https://www.privilegelimo.com/services/monthly-car-rental-with-driver ",
  },
  {
    ...
    <div className="grid lg:grid-cols-2 gap-0 lg:items-end">
      ...
      <div className="pb-12 lg:pb-16 pr-0 lg:pr-12">
        ...
        <p className="mt-6 text-sm leading-[1.9] text-[#7a7a7a] font-light max-w-lg">
          Looking for a reliable and stylish van rental in UAE? Our Mercedes
          Sprinter rental service offers unmatched luxury and comfort. Choose
          from our Sprinter Avant Garde VIP and Mercedes Sprinter Ultra Luxury
          vans for your transportation needs in Dubai.
        </p>
      ...
      <div className="relative h-[340px] sm:h-[420px] lg:h-[500px] rounded-t-[32px] overflow-hidden">
        <Image
          src="/images/fleet/mercedes-business-class-sprinter-1.webp"
          alt="Mercedes Sprinter Van Rental Dubai"
          fill
          priority
