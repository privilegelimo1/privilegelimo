          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-end">
            ...
            <div>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-[68px] font-extralight text-[#0a0a0a] leading-[1.04] tracking-tight mb-6">
                Wedding
                <br />
                <span className="text-[#AB5461] italic font-extralight">Limo</span>
                <br />
                Dubai
              </h1>

              <p className="text-[#7a7a7a] text-base font-light leading-relaxed max-w-lg mb-4">
                Luxury bridal car hire and chauffeur service for your wedding day in Dubai — from
                the couple's arrival vehicle to coordinated guest shuttles and full wedding fleet
                management.
              </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <a
                      href={`https://wa.me/971509200818?text=${encodeURIComponent(
                        `Hi, I'd like to book the ${car.name} for my wedding. Can you share availability and pricing?`
                      )}`}
                      target="_blank"
                      rel="noreferrer"
