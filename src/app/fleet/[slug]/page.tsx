      ...
      <section className="pt-28 sm:pt-32 pb-0 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-0 lg:items-end">
            ...
            {/* Left — info */}
            <div className="pb-12 lg:pb-16 pr-0 lg:pr-14">
              {/* Breadcrumb */}
              ...
              <p className="text-sm leading-[1.9] text-[#7a7a7a] font-light max-w-lg mb-2">
                {vehicle.description}
              </p>
            ...
            {/* Right — hero image */}
            <div className="relative h-[360px] sm:h-[440px] lg:h-[560px] rounded-t-[32px] overflow-hidden">
              {vehicle.images?.[0] ? (
                <Image
