...
export default function Footer() {
  const services = [
    ...
    { label: "Corporate Travel",            href: "/services/corporate-chauffeur" },
    { label: "Weddings & Events",           href: "/services/wedding-car-rental" },
    ...
    { label: "VIP Chauffeur",               href: "/services/vip-chauffeur" },
  ];
            ...
            <ul className="flex flex-col gap-3">
              {services.map((s) => (
                <li key={s.label}>
                  <Link
                    href={s.href}
                    className="text-sm text-white hover:text-white transition-colors duration-300 font-light"
                  >
                    {s.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5">
              {[
                ...
                <li key={item.label}>
                  <span className="text-[9px] tracking-[0.35em] uppercase text-white block mb-1">
                    {item.label}
                  </span>
                  {item.href ? (
                    <a
                      href={item.href}
                      className="text-sm text-white hover:text-white transition-colors font-light"
                    >
                      {item.value}
                    </a>
                  ) : (
